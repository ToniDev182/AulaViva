...
var image = ["banner1", "banner2", "banner3", "banner4", "banner5"];
...
function nextImage() {
    ...
    slider_content.innerHTML = "<img  class=\"imagenes-banners\" src=assets/banner/" + image[i] + ".jpg>";
}
...
function beforeImage() {
    ...
    slider_content.innerHTML = "<img  class=\"imagenes-banners\" src=assets/banner/" + image[i - 1] + ".jpg>";
}